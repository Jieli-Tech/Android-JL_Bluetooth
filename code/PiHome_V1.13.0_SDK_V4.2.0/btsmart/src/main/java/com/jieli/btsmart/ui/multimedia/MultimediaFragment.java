...
import com.jieli.btsmart.ui.translate.session.TranslationSessionFragment;
...
//                    break;
                case FunctionItemData.FunctionItemType.FUNCTION_ITEM_TYPE_TRANSLATE: {
                    Bundle bundle = new Bundle();
                    bundle.putParcelable(SConstant.KEY_BLUETOOTH_DEVICE, mPresenter.getConnectedDevice());
                    ContentActivity.startActivity(requireContext(), TranslateFragment.class.getCanonicalName(), getString(R.string.translation), bundle);
                    break;
                }
                case FunctionItemData.FunctionItemType.FUNCTION_ITEM_TYPE_TRANSLATE_RECORD: {
                    Bundle bundle = new Bundle();
                    bundle.putParcelable(SConstant.KEY_BLUETOOTH_DEVICE, mPresenter.getConnectedDevice());
                    ContentActivity.startActivity(requireContext(), TranslationSessionFragment.class.getCanonicalName(),
                            getString(R.string.translation_record), bundle);
                    break;
                }
            }
        });
