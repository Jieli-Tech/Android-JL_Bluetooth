...
public class DeviceListFragmentModify extends BaseFragment implements NetworkStateHelper.Listener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mAdapter.setEmptyView(View.inflate(requireContext(), R.layout.view_unconnected_device_1, null));
        ...
        mAdapter.setOnItemClickListener((adapter, view13, position) -> {
            ...
            if (mAdapter.isUsingDevice(historyDevice)) {
                ...
                if (!BluetoothUtil.isBluetoothEnable()) {
                    showTips(getString(R.string.bluetooth_not_enable));
                    return;
                }
...
//                                mView.devNeedReboot();
    ...
    private boolean isCanUseTws(BluetoothDevice device) {
        return UIHelper.isSupportTws(mRCSPController, device);
    }
    ...
    private final class DeviceStateReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(SConstant.ACTION_DEVICE_CONNECTION_CHANGE)) {
                ...
                JL_Log.d(TAG, "DeviceStateReceiver", "ACTION_DEVICE_CONNECTION_CHANGE ---> state = " + state);
