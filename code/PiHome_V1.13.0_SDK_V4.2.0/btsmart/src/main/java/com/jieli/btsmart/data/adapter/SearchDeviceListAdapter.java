...
//                ivLocation.setVisibility(isEditMode ? View.GONE : View.VISIBLE);
        ...
        ivDeviceType.setImageResource(DefaultResFactory.createBySdkType(historyBluetoothDevice.getAddress(),
                historyBluetoothDevice.getChipType(), historyBluetoothDevice.getAdvVersion()).getOnMapListIcon());
