...
//        setBanShowDialog(isDevConnected());
    ...
    public void connectBtDevice(BluetoothDevice device, BleScanMessage bleScanMessage) {
        JL_Log.d(tag, "connectBtDevice", "device : " + device + ", hasAdv : " + (null != bleScanMessage));
        BTRcspHelper.connectDeviceByMessage(mRCSPController, device, bleScanMessage);
    }
            ...
            switch (commandId) {
                case Command.CMD_ADV_DEVICE_NOTIFY:
                    ...
                    if (device != null && advInfo != null) {
                        ...
                        if (UIHelper.isSupportTws(mRCSPController, device)) {
