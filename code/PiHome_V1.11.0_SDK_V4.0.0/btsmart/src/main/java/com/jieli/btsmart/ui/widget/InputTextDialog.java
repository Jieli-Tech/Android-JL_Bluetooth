...
public class InputTextDialog extends DialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.dialog_input_text, container);
        initView(view);
    ...
    private class CustomTextWatcher implements TextWatcher {
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            if (mBuilder != null && mBuilder.getOnInputTextListener() != null) {
                mBuilder.getOnInputTextListener().onInputText(InputTextDialog.this,s.toString());
            }
        }
        ...
        public void onClick(View v) {
            if (v == mLeftTv) {
                ...
                if (mBuilder != null && mBuilder.getOnInputTextListener() != null) {
                    ...
                    mBuilder.getOnInputTextListener().onInputFinish(InputTextDialog.this,text,mBuilder.inputText);
                }
            }
        }
    };
    ...
    public interface OnInputTextListener {
        ...
        void onDismiss(InputTextDialog dialog);

        void onInputText(InputTextDialog dialog,String text);

        void onInputFinish(InputTextDialog dialog,String value,String lastValue);
    }
}
