...
public class SConstant {
    ...
    public static final String KEY_CURRENT_SCREEN = "key_current_screen_saver";
    public static final String KEY_CHARGING_CASE_INFO = "key_charging_case_info";
    public static final String KEY_CONVERT_RESULT = "key_convert_result";

    public static final String KEY_DEVICE_SCREEN_WIDTH = "key_device_screen_width";
    public static final String KEY_DEVICE_SCREEN_HEIGHT = "key_device_screen_height";
    ...
    /*Screen Savers*/
    public static final String CROP_FILE_NAME = ResourceInfo.CUSTOM_SCREEN_NAME + "-src.jpeg";
    ...
    public final static String ACTION_SCREEN_SAVER_CHANGE = "com.jieli.btsmart.upload_screen_saver_success";
    public final static String ACTION_RESOURCE_INFO_CHANGE = "com.jieli.btsmart.resource_info_change";
