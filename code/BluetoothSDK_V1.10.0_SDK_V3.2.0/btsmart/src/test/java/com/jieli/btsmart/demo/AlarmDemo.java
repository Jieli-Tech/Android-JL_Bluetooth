...
public class AlarmDemo {
    ...
    @Test
    void addOrModifyAlarm(AlarmBean alarm) {
        //获取RCSPController对象
        RCSPController controller = RCSPController.getInstance();
        //执行添加或修改闹钟功能并等待结果回调
    ...
    @Test
    void deleteAlarm(AlarmBean alarm) {
        //获取RCSPController对象
        RCSPController controller = RCSPController.getInstance();
        //执行删除闹钟功能并等待结果回调
    ...
    @Test
    void readAlarmBellArgs(byte alarmIndex) {
        //获取RCSPController对象
        RCSPController controller = RCSPController.getInstance();
        //mask - 闹钟序号
    ...
    @Test
    void setAlarmBellArg(AlarmExpandCmd.BellArg alarmBellArg) {
        //获取RCSPController对象
        RCSPController controller = RCSPController.getInstance();
    ...
    @Test
    void auditionAlarmBell(AuditionParam param) {
        //获取RCSPController对象
        RCSPController controller = RCSPController.getInstance();
        //执行试听闹钟铃声功能并等待结果回调
